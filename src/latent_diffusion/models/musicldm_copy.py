...
class MusicLDM(DDPM):
    ...
    # # Experiment 1 & 2
    # def get_trainable_params(self, path):        
    #     # gt = self.state_dict()
    #     print("*"*48)
    #     print("Get trainable params")
    #     print("*"*48)
    #     new_params = []
    ...
    #     missing_keys_mapped = set()
    #     for key in self.missing_keys:
    #         if key.startswith("model."):
    #             mapped_key = key[6:]
    #             missing_keys_mapped.add(mapped_key)
    #         else:
    #             print(f"Not mapped param: {key}")
    #             missing_keys_mapped.add(key)
        
    #     print(f"Original missing_keys: {len(self.missing_keys)}")
    #     print(f"Mapped missing_keys: {len(missing_keys_mapped)}")
        
    #     for name, param in self.model.named_parameters():
    #         print(f"Checking param: {name}")
            
    #         if name in missing_keys_mapped:
    #             print(f"Missing param: {name}")
    #             if "lora" in name:
    #                 print(f"Lora param: {name}")
    #                 new_params_lora.append(param)
    #             else:
    #                 print(f"Not lora param: {name}")
    #                 new_params.append(param)
    #         elif "emb_layers" in name:
    #             new_params.append(param)
    #             print(f"Emb layers param: {name}")
        
    #     print("New params: ", len(new_params))
    #     print("New params lora: ", len(new_params_lora))
    #     exit()
    #     return new_params, new_params_lora
